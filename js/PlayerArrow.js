class PlayerArrow {
  constructor(x, y, width, height) {
    ...
    //uncomment coreect way of defining an array named trajectory
    //this.trajectory = {};
    this.trajectory = [];
    //this.trajectory = ();
  ...
  display() {
      ...
      /****Uncomment correct for loop to display small dots
     ...
     //  {
      // fill("white");
      // circle(this.trajectory[i][0], this.trajectory[i][1], 5, 5);
      // }
